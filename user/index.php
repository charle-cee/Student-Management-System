       ...
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          ...
          <div class="readmore">
          <a href="admin/login.php">Login<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
...
{               ?>
		...
		<a href="view-public-notice.php?viewid=<?php echo htmlentities ($row->ID);?>"style="color:#fff;">
