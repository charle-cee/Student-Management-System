                                ...
                                <div class="card-body">
                                    <div class="container-responsive mt-4">
                                        <div class="table-responsive border rounded p-1">
                                            ...
                                            <h6 class="text-blue text-center">FORM 4 END OF TERM RESULTS</h6>
                                                          ...
                                                          // SQL query to retrieve distinct student names and their IDs
                                                            ...
                                                            $sqlResults = "SELECT DISTINCT s.StudentName, sr.stuID, sr.position, sr.points, sr.result
                                                                        ...
                                                                        WHERE sr.class = 4
                                                                            ...
                                                                            AND sr.term = :term
                                                                        ORDER BY COALESCE(sr.position, 9999) ASC, COALESCE(sr.points, 9999) ASC";
...
<script>
    function generatePDF() {
        ...
        const options = {
            margin: 0,
            filename: '<?php echo "Form 4 End of term result_" . $academicYear . "_term " . $activeTerm; ?>.pdf',
