...
$usertype = $result['UserType'];
 ...
 $notmsg=$_POST['notmsg'];
 $eid=$_GET['editid'];
$sql="update tblnotice set NoticeTitle=:nottitle,NoticeMessage=:notmsg where ID=:eid";
$query=$dbh->prepare($sql);
$query->bindParam(':nottitle',$nottitle,PDO::PARAM_STR);
$query->bindParam(':notmsg',$notmsg,PDO::PARAM_STR);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
 header('location:edit-notice-detail.php?editid='. urlencode($eid) .'&success=An Announcement has been updated successfully.');
 exit();
}
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Detailed Private Annoucement</h4>
                   
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <?php
$eid=$_GET['editid'];
$sql="SELECT * from tblnotice where ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                ...
                <input type="text" name="nottitle" value="<?php echo htmlentities(strtoupper($row->NoticeTitle)); ?>" class="form-control" required="true" style="font-weight: bold; border: none; background: transparent; width: 100%;">
                      ...
                      <div class="form-group">
                       <textarea name="notmsg" rows="4" style="resize: both;" class="form-control" required="true"><?php echo htmlentities($row->NoticeMsg); ?></textarea>
                      </div>
                   <?php $cnt=$cnt+1;}} ?>
