...
<div class="container-responsive mt-4">
    ...
    <h5 class="textblue text-center">BISHOP AUNEAU GIRLS CATHOLIC SECONDARY SCHOOL</h5>
        <h6 class="text-blue text-center">FORM 4 MID TERM RESULTS</h6>
...
$sqlResults = "SELECT DISTINCT s.StudentName, sr.stuID
               ...
               WHERE sr.class = 4"; // Only filtering by class
...
$result = ($subcount == 6) ? 'PASS' : 'FAIL';
    ...
    $result = ($total < 6 ||$total > 42|| $englishGrade === 9) ? 'FAIL' : 'PASS';
...
<script>
    function generatePDF() {
        ...
        const options = {
            margin: 0,
            filename: '<?php echo "Form 3 Mid term result_" . $academicYear . "_term " . $activeTerm; ?>.pdf', // Filename based on student name, academic year, and term
            image: {
                type: 'jpeg',
                quality: 1
            },
