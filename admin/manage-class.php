              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="add-class.php" class="text ml-auto mb-3 mb-sm-0" style="background :#003366; color : white;padding :10px;"><i class="icon-plus"></i> Add New Class</a>
                  </div>
...
{               ?>   
    ...
    <div style="display: flex; align-items: center; gap: 10px;">
        <!-- View Action -->
        <a href="edit-class-detail.php?editid=<?php echo htmlentities($row->ID); ?>" style="text-decoration: none; color: #003366; transition: color 0.3s;">
            <i class="fas fa-eye" style="font-size: 18px;"></i>
        </a>
        <span style="color: #ccc;">|</span>
        <!-- Delete Action -->
        <a href="manage-class.php?delid=<?php echo htmlentities($row->ID); ?>" onclick="return confirm('Do you really want to Delete?');" style="text-decoration: none; color: #dc3545; transition: color 0.3s;">
