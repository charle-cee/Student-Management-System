...
<html lang="en">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Manage Private Notice </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Manage Private Notice</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Private Notice</h4>
                      <a href="add-notice.php"class="ml-auto mb-3 mb-sm-0" style="background-color: #003366; color: white; border-radius: 40px; padding: 10px 20px; border: none; text-decoration: none; display: inline-block;">Add New Private Notice</a>
                    </div>
  ...
  <tr>
    ...
    <th class="font-weight-bold">Action</th>
       ...
       $ret = "SELECT ID FROM tblnotice ORDER BY ID DESC";
...
{               ?>   
    ...
    <a href="edit-notice-detail.php?editid=<?php echo htmlentities($row->ID); ?>" 
       style="background-color: #003366; color: white; padding: 5px 15px; border-radius: 40px; text-decoration: none; display: inline-block; margin-right: 10px;">
    ...
    <a href="manage-notice.php?delid=<?php echo ($row->ID); ?>" 
       ...
       style="background-color: yellow; color: #003366; padding: 5px 15px; border-radius: 40px; text-decoration: none; display: inline-block;">
