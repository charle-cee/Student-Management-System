                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex align-items-center mb-4">
                                    ...
                                    <a href="borrow-books.php" class="text ml-auto mb-3 mb-sm-0" style="background-color: yellow; color: #003366; padding: 10px; border-radius :40px;"> Student Borrow</a>
                                    <a href="staff-borrow.php" class="btn ml-auto mb-3 mb-sm-0" style="background-color: #003366; color: white; padding: 10px;"> Staff Borrow</a>
                                    <a href="register-books.php" class="btn ml-auto mb-3 mb-sm-0" style="background-color: #003366; color: white; padding: 10px;"> Add New Book</a>
                                </div>
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            foreach ($results as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-book.php?id=<?php echo $row->id; ?>"><i class="icon-pencil" style="background-color: #003366; color: white; padding: 10px;"> Edit</i> </a>
                                                        <a href="register-books.php?del=<?php echo $row->id; ?>" onclick="return confirm('Are you sure you want to delete this book?')"><i class="icon-trash" style="background-color: yellow; color: #003366; padding: 10px;"> Delete</i></a>
                                                    </td>
                                                </tr>
                                                <?php $cnt = $cnt + 1;
                                            } ?>
