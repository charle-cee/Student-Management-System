...
<button type="button" class="btn" onclick="generatePDF()" 
    ...
    <i class="fas fa-download" style="font-size: 20px;"></i>
                         ...
                         <div class="card-body">
    <a href="previous-results2.php?user=<?php echo $user; ?>&id=<?php echo $stuID; ?>" 
       class="btn" 
...
if (!empty($finalScore)) { // Check if $finalScore is not empty
    if (is_numeric($finalScore)) { // Ensure $finalScore is numeric
        echo htmlentities($finalScore); // Output the score
    } else {
        echo strtoupper($finalScore); // If not numeric, convert to uppercase (e.g., "AB")
    }
} else {
    echo 'NA'; // Handle the case where $finalScore is empty
}
?>
...
if ($queryEnglishGrade && $queryEnglishGrade->rowCount() > 0) {
    ...
    // Check if the English grade is F
