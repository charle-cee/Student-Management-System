                    ...
                    <div class="main-panel">
                        <div class="content-wrapper">
                            <div class="page-header">
                                <h3 class="page-title"> Returning Book </h3>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"> Returning Book</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="row">
                                <div class="col-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title" style="text-align: center; background-color: yellow; color: #003366; padding: 10px;">Returning Book</h4>
                                ...
                                <?php } ?>
                                                <thead>
                                                    <tr style="background-color : #003366; color:white; padding: 10px 20px;">
                                                            <th><b>#</b></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($result as $row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="return-btn" style="background-color: yellow; color: #003366; padding: 10px 20px;" onclick="confirmReturn('<?php echo htmlentities($row['book_number']); ?>')">Return</button>
                                                            </td>
                                                        </tr>
                                                        <?php $cnt = $cnt + 1;
                                                    } ?>
...
<script>
    function confirmReturn(bookNumber, stuID, name, className) {
        if (confirm('Are you sure you want to return the book with number ' + bookNumber + '?')) {
            ...
            header('location: borrow-books.php?error=You have not borrowed any book ');
            exit();
        }
    } else {
        header('location: return-book.php?error=Invalid parameters.');
        exit();
    }
}
?>
