        ...
        foreach ($results as $row) {
            ...
            <tr>
                ...
                <td>
                    ...
                    $staffID = $row->ID;
                    $book_sql = "SELECT COUNT(*) AS total_books FROM tblbook WHERE userID = :staffID";
                    $book_query = $dbh->prepare($book_sql);
                    $book_query->bindParam(':staffID', $staffID, PDO::PARAM_INT);
                    $book_query->execute();
                ...
                <td>
                    <div>
                        <a href="staff-borrow-action.php?id=<?php echo htmlentities($row->ID); ?>&name=<?php echo htmlentities($row->Name); ?>&role=<?php echo htmlentities($row->Role1); ?>" class="btn" style="background-color: #003366; color: white; padding: 10px; ">Borrow</a>
                        <a href="staff-return-book.php?id=<?php echo htmlentities($row->ID); ?>&name=<?php echo htmlentities($row->Name); ?>&role=<?php echo htmlentities($row->Role1); ?>" class="btn" style="background-color: yellow; color: #003366; padding: 10px; "> Return</a>
                    </div>
                </td> 
            </tr>
            <?php $cnt = $cnt + 1;
